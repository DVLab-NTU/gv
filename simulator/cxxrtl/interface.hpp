...
public:
    ...
    SET_VALUE_FUNC(3,unsigned);
    SET_VALUE_FUNC(8,unsigned);
    ...
    void setValue(size_t value) {
        ...
        SET_WIDTH_CONDITION(3);
        SET_WIDTH_CONDITION(8);
        // End (Code is generated by GV)
    }
...
public:
    Interface(cxxrtl::debug_items* items) {
        ...
        // CLK Init
        SET_CXX_SIGNAL(clk, "i_clk");
        // End (Code is generated by GV)

        // RST Init
        SET_CXX_SIGNAL(rst, "i_rst_n");
        // End (Code is generated by GV)

        // PI Init List
        SET_CXX_SIGNAL(pi, "i_inst");
        SET_CXX_SIGNAL(pi, "i_data_b");
        SET_CXX_SIGNAL(pi, "i_data_a");
        SET_CXX_SIGNAL(pi, "i_valid");
        // End (Code is generated by GV)

        // PO Init List
        SET_CXX_SIGNAL(po, "o_data");
        SET_CXX_SIGNAL(po, "o_valid");
        // End (Code is generated by GV)
