...
parseError(CirParseError err) {
    switch (err) {
        case EXTRA_SPACE:
            cout << "[ERROR] Line " << lineNo + 1 << ", Col " << colNo + 1
        ...
        case ILLEGAL_WSPACE:  // for non-space white space character
            ...
            break;
        case ILLEGAL_NUM:
            cout << "[ERROR] Line " << lineNo + 1 << ": Illegal "
                 << errMsg << "!!" << endl;
            break;
        case ILLEGAL_IDENTIFIER:
            cout << "[ERROR] Line " << lineNo + 1 << ": Illegal identifier \""
                 << errMsg << "\"!!" << endl;
            break;
        ...
        case MISSING_IDENTIFIER:
            cout << "[ERROR] Line " << lineNo + 1 << ": Missing \""
                 << errMsg << "\"!!" << endl;
            break;
        case MISSING_NEWLINE:
            ...
            break;
        case MISSING_DEF:
            cout << "[ERROR] Line " << lineNo + 1 << ": Missing " << errMsg
                 << " definition!!" << endl;
            break;
        ...
        case MAX_LIT_ID:
            ...
            break;
        case REDEF_GATE:
            cout << "[ERROR] Line " << lineNo + 1 << ": Literal \"" << errInt
                 << "\" is redefined, previously defined as "
                 << errGate->getTypeStr() << " in line " << errGate->getLineNo()
                 << "!!" << endl;
            break;
        case REDEF_SYMBOLIC_NAME:
            cout << "[ERROR] Line " << lineNo + 1 << ": Symbolic name for \""
        ...
        case REDEF_CONST:
            ...
            break;
        case NUM_TOO_SMALL:
            cout << "[ERROR] Line " << lineNo + 1 << ": " << errMsg
